...
namespace IMAS.UnitOfWork
{
    ...
    {
        public IMASModel _context;
        public CoreUnitOfWork()
        {
            _context = new IMASModel();
        }
        ...
        public GenericRepository<Profile> ProfileRepository
        {
            get
            {
                return _profileRepository == null ? _profileRepository = new GenericRepository<Profile>(_context) : _profileRepository;
            }
        }
        ...
        private GenericRepository<Advertisment> _advertismentRepository;
        public GenericRepository<Advertisment> AdvertismentRepository => _advertismentRepository ?? (_advertismentRepository = new GenericRepository<Advertisment>(_context));

        private GenericRepository<Picture> _pictureRepository;
        public GenericRepository<Picture> PictureRepository => _pictureRepository ?? (_pictureRepository = new GenericRepository<Picture>(_context));

        private GenericRepository<AdvertismentVisit> _advertismentVisitRepository;
        public GenericRepository<AdvertismentVisit> AdvertismentVisitRepository => _advertismentVisitRepository ?? (_advertismentVisitRepository = new GenericRepository<AdvertismentVisit>(_context));
