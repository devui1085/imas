...
using IMAS.UI.Properties;

namespace IMAS.UI.Areas.User.ViewModels.UserManagement
{
    public class EditUserViewModel
    {
        ...
        //public EditUserViewModel(IMAS.Model.Domain.Core.User user)
        //{
        //    UserId = user.Id;
        //    Email = user.Email;
        ...
        //public void CopyToUser(IMAS.Model.Domain.Core.User target)
        //{
        //    target.Id = UserId ;
        //    target.Email = Email ;
