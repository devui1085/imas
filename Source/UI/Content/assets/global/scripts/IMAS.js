...
var zw = {
    ...
    strings: {
        ...
        sendingImages:'در حال ارسال تصاویر',
        error: 'خطا',
        yes: 'بله',
        no: 'خیر',
        title: 'عنوان',
        statusTitle:'وضعیت آگهی',
        published: 'منتشر شده',
        ...
        edit: 'ویرایش',
        sender: 'ارسال کننده',
        advertismentStatus: 'وضعیت آگهی',
        visitsCount: 'تعداد بازدید',
        name: 'نام',
        email: 'ایمیل',
        selectAnItem: 'لطفا یک مورد را انتخاب کنید',
        inputRequired: 'فیلدهای ضروری را پرنمایید',
        AdvertismentTypeIdentity : "نوع آگهی"
    },
